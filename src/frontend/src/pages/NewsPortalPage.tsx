...
function NewsPortalForm() {
  ...
  return (
    <>
      ...
      <div className="glass-card-elevated border border-border/50 px-6 py-5 flex items-center gap-3">
      ...
      <div className="panel-shell panel-shell-lg border border-border/40 bg-card/60 p-4 space-y-4">
                  <div className="space-y-2">
...
export default function NewsPortalPage() {
  return (
    <AppShell>
      ...
      <div className="panel-shell panel-shell-lg border border-border/40 bg-card/60 px-6 py-5">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
        ...
        <RoleGuard
          ...
          fallback={
      <div className="panel-shell panel-shell-lg border border-border/40 bg-card/60 p-8 text-center">
